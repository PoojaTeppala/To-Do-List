...
class ToDoListApp:
    ...
    def create_widgets(self):
        ...
        self.add_button=tk.Button(self.master,text="Add Task",command=self.add_task,bg="#4CAF50",
        ...
        self.mark_complete_button=tk.Button(self.master,text="Mark as Complete",command=self.mark_complete,
        ...
        self.edit_button=tk.Button(self.master,text="Edit Task",command=self.edit_task,bg="#FFC107",
    ...
    def remove_task(self,event=None):
        ...
        if selected_index:
            index=selected_index[0]
            confirmation=messagebox.askyesno("Confirmation", "Are you sure you want to remove
                                             this task?")
            if confirmation:
                self.task_listbox.delete(index)
